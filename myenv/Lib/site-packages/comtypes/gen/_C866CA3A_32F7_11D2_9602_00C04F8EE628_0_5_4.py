...
__all__ = [
    'ISpMMSysAudio', 'DISPID_SDKSetLongValue', 'SECFEmulateResult',
    'SGPronounciation', 'SPBOOKMARKOPTIONS', 'DISPID_SGRsDynamic',
    'DISPID_SRGCmdLoadFromMemory', 'ISpNotifySink', 'SVF_Emphasis',
    'DISPID_SRCESoundEnd', 'DISPID_SRIsUISupported', 'SGLexical',
    'SAFTGSM610_8kHzMono', 'ISpeechPhraseProperties',
    'DISPID_SDKDeleteKey', 'SPEI_VISEME', 'Speech_Max_Pron_Length',
    'SP_VISEME_5', 'ISpRecognizer2', 'SpNullPhoneConverter',
    'SRESoundEnd', 'DISPID_SRRTLength', 'SpeechGrammarTagDictation',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SAFT16kHz16BitStereo',
    'SREStreamEnd', 'DISPID_SOTDataKey', 'DISPID_SFSOpen',
    'SVSFIsNotXML', 'IEnumString', 'eLEXTYPE_RESERVED7',
    'SDTPronunciation', 'SPEI_PROPERTY_NUM_CHANGE',
    'SpeechStreamSeekPositionType', 'SpCompressedLexicon', 'SVP_12',
    'ISpeechPhraseProperty', 'DISPID_SPELexicalForm',
    'DISPID_SGRName', 'SITooQuiet', 'ISequentialStream',
    'SPLO_STATIC', 'DISPID_SRCCreateResultFromMemory',
    'SPDKL_CurrentConfig', 'eLEXTYPE_PRIVATE3', 'DISPID_SRAudioInput',
    'SVEVoiceChange', 'DISPID_SRCEEnginePrivate', 'SPPS_Noncontent',
    'SDA_Consume_Leading_Spaces', 'DISPID_SpeechGrammarRules',
    'DISPID_SPIReplacements', 'SRAInterpreter', 'SPFM_NUM_MODES',
    'eLEXTYPE_PRIVATE19', 'SpeechVoicePriority',
    'SpeechRegistryUserRoot', 'SVP_5', 'SPEI_TTS_AUDIO_LEVEL',
    'SVPAlert', 'DISPID_SPEAudioStreamOffset',
    'SPINTERFERENCE_NOSIGNAL', 'SPEI_MAX_SR', 'DISPID_SRGRecoContext',
    'SpeechTokenValueCLSID', 'SPPS_Noun', 'SpeechInterference',
    'SAFT22kHz16BitMono', 'eLEXTYPE_PRIVATE2', 'SPCT_DICTATION',
    'DISPID_SLWPronunciations', 'DISPID_SDKOpenKey', 'SVP_20',
    'DISPID_SVSLastBookmarkId', 'SBONone', 'SAFTADPCM_22kHzMono',
    'DISPID_SVESentenceBoundary', 'SVP_9', 'SRAImport',
    'SPLEXICONTYPE', 'DISPID_SRSClsidEngine', 'DISPID_SRRTimes',
    'SPSInterjection', 'DISPID_SAStatus', 'DISPID_SPAPhraseInfo',
    'SPSSuppressWord', 'DISPID_SPIGrammarId',
    'ISpStreamFormatConverter', 'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechRuleAttributes', 'SAFTText', 'STSF_CommonAppData',
    'SPWORDPRONOUNCEABLE', 'DISPID_SpeechWaveFormatEx',
    'eLEXTYPE_PRIVATE5', 'DISPID_SPEActualConfidence',
    'DISPID_SABIBufferSize', 'SpNotifyTranslator',
    'eLEXTYPE_PRIVATE9', 'SPAUDIOOPTIONS', 'SSSPTRelativeToEnd',
    'DISPID_SRState', 'ISpeechLexiconPronunciations',
    'SAFT24kHz16BitMono', 'SpeechVoiceCategoryTTSRate',
    'SAFT32kHz16BitStereo', 'DISPID_SLPLangId',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechAudio', 'SPEI_REQUEST_UI', 'SDA_No_Trailing_Space',
    'DISPID_SRCreateRecoContext', 'SPEI_VOICE_CHANGE',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SABufferNotifySize',
    'SDA_Two_Trailing_Spaces', 'DISPID_SWFEChannels',
    'DISPID_SVSLastStreamNumberQueued', 'SVSFPurgeBeforeSpeak',
    'DISPID_SPIElements', 'SRAONone', 'SPINTERFERENCE_NOISE',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRGCommit', 'SPLO_DYNAMIC',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRRSetTextFeedback',
    'eLEXTYPE_USER', 'SPFM_CREATE', 'SVSFIsFilename',
    'DISPID_SRCPause', 'SPEI_SR_RETAINEDAUDIO', 'ISpeechGrammarRules',
    'SRERecognition', 'DISPID_SpeechPhraseRule', 'SPPS_Verb',
    'SPPS_SuppressWord', 'DISPID_SVVolume', 'SPEI_RESERVED2',
    'SPPROPERTYINFO', 'DISPID_SRRecognizer',
    'DISPID_SRSetPropertyString', 'ISpeechRecognizer', 'ISpEventSink',
    'SVP_13', 'DISPID_SGRSTs_NewEnum', 'DISPID_SADefaultFormat',
    'SPFILEMODE', 'SAFT8kHz8BitMono', 'SpSharedRecognizer',
    'SpShortcut', 'SpeechAudioVolume', 'SP_VISEME_18', 'SLOStatic',
    'DISPID_SGRsItem', 'DISPID_SpeechRecognizer', 'SpPhoneConverter',
    'DISPID_SGRSTType', 'DISPID_SOTsItem', 'SPWORD', 'SPCONTEXTSTATE',
    'SECFIgnoreWidth', 'SLODynamic', 'SpMemoryStream',
    'SPPS_NotOverriden', 'SpObjectTokenCategory', 'SP_VISEME_3',
    'DISPID_SRGetPropertyNumber', 'SP_VISEME_6', 'DISPID_SGRClear',
    'SpObjectToken', 'SAFTADPCM_44kHzStereo', 'DISPID_SRCVoice',
    'SAFT44kHz16BitStereo', 'ISpeechRecoResultTimes',
    'SAFT44kHz8BitStereo', 'DISPID_SRProfile', 'DISPID_SGRSTWeight',
    'SAFTCCITT_ALaw_22kHzMono', 'SpeechEmulationCompareFlags',
    'SpeechUserTraining', 'DISPID_SVDisplayUI', 'DISPID_SOTCSetId',
    'SSTTWildcard', 'SPSModifier', 'SpeechTokenIdUserLexicon',
    'SDTReplacement', 'SAFT22kHz8BitMono', 'SPSHORTCUTPAIR',
    'SpVoice', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRGReset', 'ISpGrammarBuilder', 'eLEXTYPE_RESERVED8',
    'ISpeechAudioStatus', 'DISPID_SPANumberOfElementsInResult',
    'ISpeechPhraseElement', 'DISPID_SGRId', 'DISPID_SLPType',
    'SpeechRegistryLocalMachineRoot', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpeechFormatType', 'DISPID_SPRNumberOfElements', 'SP_VISEME_19',
    'DISPID_SGRsFindRule', 'SPDKL_LocalMachine', 'DISPID_SMSSetData',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SLPSymbolic',
    'DISPID_SRRPhraseInfo', 'SP_VISEME_1',
    'DISPID_SPRuleFirstElement', 'SPGS_DISABLED', 'SVP_21',
    'ISpObjectTokenCategory', 'DISPID_SVVoice',
    'SAFTCCITT_uLaw_8kHzMono', 'SWPUnknownWordUnpronounceable',
    'DISPID_SPIRetainedSizeBytes', 'SSFMCreateForWrite',
    'SpeechPropertyHighConfidenceThreshold', 'SLTUser',
    'SDTAlternates', 'SLTApp', 'DISPID_SLWType', 'SREStateChange',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPPHRASE',
    'DISPID_SRCERecognizerStateChange', 'SPRULE',
    'SpeechRecoContextState', 'SPGS_ENABLED',
    'SpeechCategoryRecoProfiles', 'DISPID_SPRulesItem',
    'DISPID_SpeechLexiconWord', 'DISPID_SVPause',
    'DISPID_SDKGetlongValue', 'SVEAudioLevel', 'SAFT22kHz16BitStereo',
    'SITooFast', 'SpeechPropertyLowConfidenceThreshold',
    'ISpeechMemoryStream', 'SAFTCCITT_ALaw_44kHzStereo',
    'SRERecoOtherContext', 'DISPID_SRCRequestedUIType',
    'SpeechTokenKeyUI', 'DISPID_SRSSupportedLanguages',
    'SPEI_WORD_BOUNDARY', 'SP_VISEME_20', 'DISPID_SDKEnumKeys',
    'DISPID_SpeechBaseStream', 'SWPKnownWordPronounceable',
    'SDTLexicalForm', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SRCEStartStream', 'SREBookmark', 'SRSActive',
    'SpeechPropertyAdaptationOn', 'DISPID_SRAudioInputStream',
    'DISPID_SRCRecognizer', 'SVSFNLPSpeakPunc', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SOTId', 'SpeechDataKeyLocation', 'DISPID_SDKEnumValues',
    'DISPID_SRGCmdSetRuleIdState', 'SPPS_Interjection',
    'DISPID_SMSGetData', 'LONG_PTR', 'SREAdaptation',
    'DISPID_SRCEInterference', 'SRSActiveAlways', 'SPGRAMMARWORDTYPE',
    'DISPID_SPRuleParent', 'SDKLDefaultLocation',
    'DISPID_SVSInputSentenceLength', 'SVSFIsXML', 'SPAS_PAUSE',
    'DISPID_SpeechRecognizerStatus', 'SPXMLRESULTOPTIONS',
    'SPAUDIOSTATE', 'DISPID_SVGetAudioOutputs', 'SPEI_HYPOTHESIS',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SpeechPhoneConverter',
    'ISpNotifyTranslator', 'SP_VISEME_21', 'SAFTADPCM_8kHzStereo',
    'SAFT24kHz16BitStereo', 'SpeechPartOfSpeech', 'DISPID_SBSFormat',
    'DISPID_SGRsCommitAndSave', 'SPADAPTATIONRELEVANCE', 'tagSTATSTG',
    'SVSFParseMask', 'SpeechAudioProperties',
    'DISPID_SpeechFileStream', 'SECNormalConfidence', 'SPSLMA',
    'ISpVoice', 'SPAO_NONE', 'SP_VISEME_9',
    ...
    'DISPID_SPPFirstElement', 'DISPID_SGRsCount', 'SRSInactive',
    'DISPID_SVSRunningState', 'ISpeechGrammarRuleStateTransitions',
    'SPPHRASERULE', 'SP_VISEME_7', 'DISPID_SpeechCustomStream',
    'DISPID_SPRuleName', 'SAFT16kHz8BitMono', 'SpPhraseInfoBuilder',
    'SVP_15', 'DISPID_SPCIdToPhone', 'SVSFUnusedFlags',
    'ISpPhoneticAlphabetConverter', 'DISPID_SOTGetAttribute',
    'SpeechCategoryAudioIn', 'SPFM_OPEN_READWRITE',
    'SPEI_SR_AUDIO_LEVEL', 'SpResourceManager',
    'DISPID_SPILanguageId', 'SpeechGrammarTagUnlimitedDictation',
    'SRTSMLTimeout', 'SVP_6', 'SpeechDiscardType',
    'SPDKL_CurrentUser', 'DISPID_SRCEAdaptation', 'ISpeechFileStream',
    'SpCustomStream', 'SpeechCategoryRecognizers',
    'DISPID_SRCEFalseRecognition', 'SVEViseme', 'DISPID_SLWsItem',
    'SPWF_SRENGINE', 'SP_VISEME_4', 'SINoSignal',
    'SPEI_SENTENCE_BOUNDARY', 'SSFMOpenForRead', 'SPEI_RESERVED5',
    'SREHypothesis', 'DISPID_SpeechDataKey', 'eLEXTYPE_PRIVATE15',
    'DISPID_SpeechLexiconPronunciation', 'IEnumSpObjectTokens',
    'DISPID_SBSWrite', 'DISPID_SOTCGetDataKey',
    'DISPID_SRGSetWordSequenceData', 'SPEI_RESERVED6', 'SRERequestUI',
    'ISpPhoneConverter', 'DISPID_SPPChildren',
    'DISPID_SpeechXMLRecoResult', 'ISpeechPhraseElements',
    'SpeechRecoEvents', 'SPEI_SOUND_END',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SpeechMemoryStream',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SOTCreateInstance',
    'SPPS_RESERVED3', 'SPVPRI_OVER', 'SGSExclusive',
    'DISPID_SPEDisplayAttributes', 'DISPID_SRGetFormat',
    'ISpeechRecoResultDispatch', 'SPPHRASEELEMENT', 'SPEVENT',
    'SPAUDIOSTATUS', 'SPAUDIOBUFFERINFO', 'eWORDTYPE_ADDED',
    'DISPID_SVGetProfiles', 'DISPID_SRCRetainedAudio',
    'DISPID_SpeechPhraseRules', 'SAFT11kHz16BitMono',
    'DISPID_SVSInputSentencePosition', 'SPEI_INTERFERENCE',
    'SPSERIALIZEDRESULT', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPCT_SUB_COMMAND', 'ISpeechPhraseRules', 'SPRS_ACTIVE',
    'SPPHRASEREPLACEMENT', 'SPBO_PAUSE', 'DISPID_SDKCreateKey',
    'DISPID_SOTCDefault', 'SVEBookmark', 'DISPID_SPPsItem',
    'DISPID_SLAddPronunciation',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SpeechLexicon',
    'DISPID_SpeechAudioFormat', 'SPSNoun', 'DISPID_SPCPhoneToId',
    'DISPID_SRRRecoContext', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SGRAddResource', 'SAFTCCITT_uLaw_11kHzMono',
    'SREStreamStart', 'SGRSTTRule', 'IStream',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SPIEngineId',
    'DISPID_SGRSTRule', 'DISPID_SLWLangId', 'DISPID_SRCERequestUI',
    'ISpEventSource', 'DISPID_SPPEngineConfidence', 'SPEI_MAX_TTS',
    'DISPID_SWFESamplesPerSec', 'SpeechAddRemoveWord',
    'SREAudioLevel', 'DISPID_SPRText', 'eLEXTYPE_RESERVED10',
    'SGRSTTEpsilon', 'DISPID_SABIMinNotification',
    'SECHighConfidence', 'SpeechGrammarWordType',
    'SSSPTRelativeToStart', 'ISpeechRecoContext', 'DISPID_SOTsCount',
    'DISPID_SPERequiredConfidence', 'SVEStartInputStream',
    'DISPID_SASState', 'SPEI_END_SR_STREAM', 'ISpeechObjectTokens',
    'SPSEMANTICERRORINFO', 'DISPID_SLGenerationId',
    'DISPID_SVAlertBoundary', 'SpeechRuleState', 'DISPID_SLPsItem',
    'DISPID_SLPs_NewEnum', 'DISPID_SVEBookmark',
    'DISPID_SPEAudioSizeTime', 'SWTAdded', 'eLEXTYPE_PRIVATE8',
    'SpeechCategoryAppLexicons', 'eLEXTYPE_APP',
    'DISPID_SPPConfidence', 'DISPID_SOTRemove', 'DISPID_SABufferInfo',
    'SVP_4', 'SPWT_DISPLAY', 'DISPID_SpeechObjectTokenCategory',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPSHORTCUTPAIRLIST',
    'SpeechTokenKeyAttributes', 'SAFT8kHz8BitStereo',
    'DISPID_SRCBookmark', 'DISPID_SPPValue', 'eLEXTYPE_VENDORLEXICON',
    'SPWT_LEXICAL', 'DISPID_SLWs_NewEnum', 'DISPID_SGRSTNextState',
    'DISPID_SPPs_NewEnum', 'SPRECORESULTTIMES', 'SPFM_OPEN_READONLY',
    'SRSEIsSpeaking', 'DISPID_SVEEnginePrivate', 'DISPID_SPRuleId',
    'ISpeechResourceLoader', 'DISPID_SPAsCount', 'SDKLCurrentConfig',
    'SPAS_RUN', 'SAFT12kHz8BitMono', 'SAFT44kHz8BitMono',
    'ISpeechTextSelectionInformation', 'SpeechVoiceSkipTypeSentence',
    'ISpeechPhraseAlternate', 'SP_VISEME_17', 'eLEXTYPE_RESERVED9',
    'DISPID_SPRFirstElement', 'IInternetSecurityMgrSite',
    'DISPIDSPTSI_ActiveOffset', 'SSTTTextBuffer', 'SPPS_RESERVED4',
    'SDKLLocalMachine', 'SGSDisabled', 'SPRULESTATE',
    'eLEXTYPE_PRIVATE7', 'SpeechLexiconType',
    'DISPID_SLPPartOfSpeech', 'SPGS_EXCLUSIVE', 'SPGRAMMARSTATE',
    'ISpeechVoiceStatus', 'SGRSTTDictation',
    ...
    'ISpAudio', 'DISPID_SPEAudioTimeOffset', 'ISpRecoCategory',
    'DISPID_SRGDictationSetState', 'SPBINARYGRAMMAR', 'SPAR_Unknown',
    'SASClosed', 'SWPUnknownWordPronounceable',
    'DISPID_SPEDisplayText', 'SECFIgnoreKanaType', 'SGDSActive',
    'SGSEnabled', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpObjectToken',
    'SPEI_MIN_SR', 'DISPID_SRSAudioStatus', 'DISPID_SVEViseme',
    'DISPID_SpeechPhraseProperties', 'eLEXTYPE_RESERVED6',
    'SPPS_Unknown', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRGSetTextSelection', 'eLEXTYPE_PRIVATE10',
    'DISPID_SVEAudioLevel', 'SAFT16kHz16BitMono',
    'SpInprocRecognizer', 'DISPID_SVPriority', 'DISPID_SpeechVoice',
    'SPVPRIORITY', 'SAFT16kHz8BitStereo', 'SAFT48kHz8BitMono',
    'DISPID_SLGetPronunciations', 'SVP_11', 'SRCS_Disabled',
    'DISPID_SPRDisplayAttributes', 'SpeechVoiceEvents',
    'SAFTCCITT_uLaw_22kHzMono', 'SPCT_COMMAND', 'ISpPhrase',
    'SpeechVisemeType', 'SPEI_TTS_PRIVATE', '_SPAUDIOSTATE',
    'SpFileStream', 'SSFMOpenReadWrite', 'SPSUnknown',
    'SAFT22kHz8BitStereo', 'DISPID_SWFEFormatTag', 'WAVEFORMATEX',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SRCERecognition',
    'ISpeechRecoResult', 'SpeechAudioFormatGUIDText',
    'SAFT12kHz16BitMono', 'DISPID_SRGDictationUnload', 'SP_VISEME_16',
    'DISPID_SRCSetAdaptationData', 'SpUnCompressedLexicon',
    'SAFTCCITT_uLaw_22kHzStereo', 'SREPropertyStringChange',
    'DISPID_SVSPhonemeId', 'SRSEDone', 'SRAORetainAudio',
    ...
    'SAFTNonStandardFormat', 'SPAR_Medium', 'DISPID_SRRAudio',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpLexicon', 'SPVPRI_ALERT',
    'SP_VISEME_11', 'ISpeechDataKey', 'DISPID_SRRGetXMLResult',
    'SpeechGrammarState', 'SPAO_RETAIN_AUDIO', 'SPAS_CLOSED',
    'SpeechEngineProperties', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SpeechPhraseInfo',
    'ISpeechPhraseInfoBuilder', 'SPSHT_EMAIL',
    'SpeechAudioFormatGUIDWave', 'DISPID_SDKSetBinaryValue',
    'SPSNotOverriden', 'DISPID_SVRate', 'STCInprocHandler',
    'SAFTGSM610_22kHzMono', 'Speech_StreamPos_RealTime',
    'DISPID_SGRSTsCount', 'DISPID_SGRSRule',
    'IInternetSecurityManager', 'DISPID_SGRSTPropertyValue',
    'ISpeechLexiconWord', 'SPINTERFERENCE_TOOLOUD',
    'SGDSActiveWithAutoPause', 'SPSEMANTICFORMAT',
    'DISPID_SVEventInterests', 'DISPID_SVEWord',
    'SpSharedRecoContext', 'SPPHRASEPROPERTY', 'SpeechTokenContext',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SGRSTsItem',
    'SPSHT_Unknown', 'SINone', 'DISPID_SPEsItem',
    'DISPID_SGRAddState', 'DISPID_SRGId', 'DISPID_SPIAudioSizeTime',
    'ISpeechPhraseReplacements', 'SVP_18', 'DISPID_SPCLangId',
    'SPRST_ACTIVE', '_RemotableHandle', 'DISPID_SVSkip',
    'SpeechAudioState', 'DISPID_SVSLastBookmark',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SASStop',
    'SpeechGrammarTagWildcard', 'SpeechCategoryPhoneConverters',
    'SRATopLevel', 'DISPID_SOTDisplayUI', 'SPAR_High',
    'DISPID_SPIGetText', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SpeechPhraseProperty', 'SPPS_RESERVED2',
    'DISPID_SGRSTText', 'SAFT11kHz8BitMono', 'SPPS_LMA',
    'DISPID_SpeechRecoResult', 'tagSPPROPERTYINFO',
    'SAFT32kHz16BitMono', 'DISPID_SRRAudioFormat',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SVWaitUntilDone', 'SDTAudio',
    'ISpeechLexiconPronunciation', 'SpStreamFormatConverter',
    'DISPID_SLPPhoneIds', 'DISPID_SVEStreamEnd', 'SPBO_AHEAD',
    'ISpStream', 'SPCS_ENABLED', 'SPINTERFERENCE', 'SVSFParseSapi',
    'DISPID_SAFGetWaveFormatEx', 'SASRun', 'SPVISEMES', 'SGRSTTWord',
    'SPAR_Low', 'DISPID_SVSyncronousSpeakTimeout',
    'SAFTCCITT_ALaw_11kHzStereo', 'SVSFPersistXML',
    'SPFM_CREATE_ALWAYS', 'DISPID_SpeechPhraseElements',
    'DISPID_SOTIsUISupported', 'SRTEmulated',
    'SPINTERFERENCE_TOOQUIET', 'SPTEXTSELECTIONINFO', 'SPVPRI_NORMAL',
    'SP_VISEME_10', 'DISPID_SAFGuid', 'SDTDisplayText',
    'SPPS_Function', 'SRCS_Enabled', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SAVolume', 'DISPID_SABIEventBias',
    'ISpPhoneticAlphabetSelection', 'DISPID_SAFType', 'SVP_17',
    'Speech_Max_Word_Length', 'DISPID_SLGetGenerationChange',
    'SPWORDPRONUNCIATIONLIST', 'SPSERIALIZEDPHRASE',
    'SPRST_INACTIVE_WITH_PURGE', 'SVP_8', 'DISPID_SMSALineId',
    'DISPID_SRCEPropertyNumberChange', 'eLEXTYPE_PRIVATE4',
    'DISPID_SWFEAvgBytesPerSec', 'SPINTERFERENCE_LATENCY_WARNING',
    'SREPhraseStart', 'ISpeechPhraseRule', 'SVEAllEvents',
    'SAFT11kHz8BitStereo', 'ISpeechWaveFormatEx',
    'DISPID_SpeechGrammarRule', 'ISpeechGrammarRule',
    'DISPID_SPPsCount', 'DISPID_SVSInputWordLength',
    'SpeechCategoryVoices', 'SpeechAllElements',
    'DISPID_SRCCmdMaxAlternates',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SSFMCreate',
    'DISPID_SRCState', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SWFEBlockAlign',
    'SRESoundStart', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SpeechObjectTokens', 'SPWORDTYPE', 'DISPID_SVSpeak',
    'SRADynamic', 'DISPID_SOTCId', 'DISPID_SpeechPhraseAlternate',
    'SpeechMicTraining', 'SPRS_INACTIVE', 'SINoise', 'ISpLexicon',
    'SFTInput', 'DISPID_SRGetRecognizers',
    'SpeechSpecialTransitionType', 'SpeechLoadOption',
    'DISPID_SVSpeakStream', 'DISPID_SpeechPhraseElement',
    '_ISpeechRecoContextEvents', 'SPEI_END_INPUT_STREAM',
    'SPPARTOFSPEECH', 'SRSInactiveWithPurge', 'DISPID_SLWWord',
    'SAFTADPCM_22kHzStereo', 'DISPID_SVGetVoices', 'SPSFunction',
    'DISPID_SGRAttributes', 'DISPID_SRRTTickCount',
    'DISPID_SDKSetStringValue', 'ISpeechBaseStream',
    'DISPID_SOTCategory', 'eLEXTYPE_PRIVATE16',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRSNumberOfActiveRules',
    'SDKLCurrentUser', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPDKL_DefaultLocation', 'SREFalseRecognition',
    'SpeechBookmarkOptions', 'DISPID_SDKGetBinaryValue',
    'DISPID_SVAudioOutputStream', 'SVSFParseSsml', 'DISPID_SPACommit',
    'DISPIDSPTSI_ActiveLength', 'ISpeechMMSysAudio',
    'DISPID_SPIStartTime', 'ISpeechVoice', 'ISpeechLexiconWords',
    'DISPID_SRIsShared', 'SPRST_NUM_STATES',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SPPName',
    'DISPID_SRCEPhraseStart', 'SAFT24kHz8BitStereo', 'STCLocalServer',
    'DISPID_SRRTOffsetFromStart', 'SPSVerb',
    'DISPID_SRSetPropertyNumber', 'ISpNotifySource', 'SPVOICESTATUS',
    'SPEI_PHONEME', 'SPEI_START_SR_STREAM', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRGDictationLoad', 'DISPID_SGRsCommit',
    'DISPID_SPRs_NewEnum', 'ISpeechAudioFormat',
    'SREPropertyNumChange', 'DISPID_SGRsAdd', 'SRADefaultToActive',
    'SPEVENTENUM', 'ISpPhraseAlt', 'ISpObjectWithToken',
    'SpeechRunState', 'DISPID_SpeechVoiceStatus',
    'DISPID_SpeechRecoResult2', 'SPSHORTCUTTYPE',
    'DISPID_SRCEBookmark', 'DISPID_SPPId', 'SFTSREngine',
    'DISPID_SPEsCount', 'DISPID_SRGetPropertyString',
    'SPEI_PHRASE_START', 'SPDATAKEYLOCATION',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SRStatus', 'SVEPhoneme',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPSHT_OTHER',
    '_ISpeechVoiceEvents', 'SPAS_STOP', 'SWTDeleted', 'SpMMAudioEnum',
    'eLEXTYPE_PRIVATE13', 'SP_VISEME_13', 'DISPID_SPEs_NewEnum',
    'SAFTDefault', 'ISpProperties', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SAFT48kHz16BitStereo', 'DISPID_SRGIsPronounceable',
    'SDTProperty', 'SPBO_TIME_UNITS', 'SPINTERFERENCE_TOOFAST',
    'SVESentenceBoundary', 'SpeechPropertyResourceUsage',
    'SpeechVisemeFeature', 'SVP_14', 'DISPID_SpeechLexiconProns',
    'DISPID_SPIRule', 'SVP_7', 'SRAExport', 'SP_VISEME_14',
    'ISpeechLexicon', 'SpeechStreamFileMode', 'SRTExtendableParse',
    'DISPID_SPIProperties', 'SPBO_NONE', 'DISPID_SRCEHypothesis',
    'SpeechPropertyResponseSpeed', 'eLEXTYPE_PRIVATE11',
    'SVSFVoiceMask', 'tagSPTEXTSELECTIONINFO', 'DISPID_SVEPhoneme',
    'SSTTDictation', 'SRTReSent', 'SPEI_START_INPUT_STREAM',
    'DISPID_SVResume', 'eLEXTYPE_PRIVATE20', 'SDA_One_Trailing_Space',
    'DISPID_SWFEExtraData', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SPPNumberOfElements', 'SpTextSelectionInformation',
    'DISPID_SpeechObjectToken', 'SVSFNLPMask', 'SAFT24kHz8BitMono',
    'SVSFParseAutodetect', 'DISPID_SBSSeek',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SREmulateRecognition',
    'SPWT_PRONUNCIATION', 'SPWORDPRONUNCIATION',
    ...
    'SAFTADPCM_44kHzMono', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPXRO_SML', 'ISpeechGrammarRuleStateTransition', 'SPWF_INPUT',
    'DISPID_SpeechGrammarRuleState', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPSMF_UPS', 'DISPID_SGRSTPropertyName', 'SVPNormal',
    'DISPID_SMSADeviceId', 'ISpeechCustomStream',
    'SpeechTokenShellFolder', 'DISPID_SPPParent',
    'DISPID_SGRInitialState', 'DISPID_SVSInputWordPosition', 'SVP_3',
    'ISpRecoResult', 'eLEXTYPE_LETTERTOSOUND', 'DISPID_SGRs_NewEnum',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SpeechRecoContext', 'SVP_1',
    'SP_VISEME_12', 'SECLowConfidence', 'DISPID_SVGetAudioInputs',
    'SAFTADPCM_8kHzMono', 'DISPID_SVSVisemeId',
    'DISPID_SVEVoiceChange', 'SGDisplay',
    'DISPID_SpeechRecoResultTimes', 'SGDSActiveUserDelimited',
    'DISPID_SPEEngineConfidence', 'DISPID_SPRuleChildren',
    'SAFTADPCM_11kHzMono', 'eLEXTYPE_RESERVED4',
    'DISPID_SPARecoResult', 'STSF_FlagCreate', 'DISPID_SOTSetId',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPRECOGNIZERSTATUS',
    'DISPID_SGRSTransitions', 'SpeechDisplayAttributes',
    'SPCS_DISABLED', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpeechAudioBufferInfo', 'DISPID_SPRuleNumberOfElements',
    'SP_VISEME_8', 'SDTRule', 'DISPID_SLGetWords', 'SREPrivate',
    'SPEI_RECOGNITION', 'SRTAutopause', 'DISPID_SRRTStreamTime',
    'ISpRecognizer3', 'SPRST_INACTIVE', 'DISPID_SVAudioOutput',
    'eLEXTYPE_USER_SHORTCUT', 'SVEPrivate', 'ISpeechRecoResult2',
    'SAFT12kHz8BitStereo', 'SPSTREAMFORMATTYPE', 'SPCT_SLEEP',
    'SpInProcRecoContext', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SLPsCount', 'DISPID_SPISaveToMemory',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SOTGetStorageFileName',
    'DISPID_SVIsUISupported', 'DISPID_SPEPronunciation', 'SASPause',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'ISpeechPhraseReplacement', 'Speech_Default_Weight',
    'SGDSInactive', 'SPEI_RESERVED3', 'ISpeechObjectTokenCategory',
    'SpeechAudioFormatType', 'SVP_10', 'SP_VISEME_15',
    'DISPID_SRCEEndStream', 'DISPID_SRCCreateGrammar',
    'DISPID_SPRsItem', 'SAFTGSM610_11kHzMono',
    'SpeechEngineConfidence', 'SpAudioFormat', 'eLEXTYPE_PRIVATE18',
    ...
    'SPEI_TTS_BOOKMARK', 'STSF_LocalAppData', 'ISpStreamFormat',
    'DISPID_SpeechVoiceEvent', 'SPEI_RECO_STATE_CHANGE', 'SVPOver',
    'DISPID_SLRemovePronunciation', 'SPPS_RESERVED1',
    'DISPID_SPAsItem', 'eLEXTYPE_PRIVATE17', 'SVF_Stressed',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SVEWordBoundary',
    'DISPID_SRCEAudioLevel', 'SpeechTokenKeyFiles',
    'SpPhoneticAlphabetConverter', 'ISpShortcut', 'SAFT8kHz16BitMono',
    ...
    'DISPID_SVStatus', 'SpMMAudioIn', 'DISPID_SRGRules',
    'SAFT8kHz16BitStereo', 'DISPID_SVEStreamStart', 'SPEI_MIN_TTS',
    'SPWORDLIST', 'DISPID_SRRAlternates', 'ISpeechPhoneConverter',
    'SVEEndInputStream', 'DISPID_SDKGetStringValue',
    'DISPID_SASCurrentDevicePosition', 'SpeechRecoProfileProperties',
    'ISpeechObjectToken', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SPRulesCount', 'eLEXTYPE_PRIVATE1',
    'Speech_StreamPos_Asap', 'DISPID_SRDisplayUI', 'SGRSTTTextBuffer',
    'DISPID_SPRsCount', 'ISpeechRecoGrammar', 'SECFNoSpecialChars',
    'eWORDTYPE_DELETED', 'DISPID_SGRSTPropertyId',
    'DISPID_SASNonBlockingIO', 'DISPID_SVSpeakCompleteEvent',
    'SVSFlagsAsync', 'SPPS_Modifier', 'SPEI_SR_BOOKMARK',
    'ISpRecognizer', 'DISPID_SCSBaseStream', 'DISPID_SRGState',
    'DISPID_SBSRead', 'DISPID_SPIGetDisplayAttributes',
    'SPEI_SR_PRIVATE', 'DISPID_SRGCmdLoadFromResource',
    'ISpeechGrammarRuleState', 'SVSFDefault', 'SAFT48kHz8BitStereo',
    'SECFDefault', 'SPWAVEFORMATTYPE', 'SGRSTTWildcard',
    'ISpeechAudio', 'STCInprocServer', 'SpMMAudioOut',
    'SPEI_ADAPTATION', 'SP_VISEME_2', 'SPEI_SOUND_START',
    'DISPID_SLWsCount', 'DISPID_SRCResume', 'SPCT_SUB_DICTATION',
    'SP_VISEME_0', 'SpeechRecognitionType', 'SAFTGSM610_44kHzMono',
    'DISPID_SpeechLexiconWords', 'ISpRecoContext2', 'SECFIgnoreCase',
    'ISpeechPhraseInfo', 'ISpeechXMLRecoResult', 'SDTAll',
    'SAFT48kHz16BitMono', 'SITooLoud', 'SpStream',
    '__MIDL_IWinTypes_0009', 'SAFT12kHz16BitStereo',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SpeechMMSysAudio',
    'DISPID_SVSLastResult', 'SVP_2', 'SAFT32kHz8BitMono', 'SVP_0',
    'DISPID_SOTs_NewEnum', 'DISPID_SPAs_NewEnum', 'SPCATEGORYTYPE',
    'SPRECOCONTEXTSTATUS', 'ISpRecoContext', 'SAFT11kHz16BitStereo',
    'DISPIDSPRG', 'SVF_None', 'SAFTCCITT_uLaw_44kHzMono',
    'SpeechRetainedAudioOptions', 'SRTStandard',
    'DISPID_SRRSaveToMemory', 'SPSHT_NotOverriden',
    'SAFTADPCM_11kHzStereo', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SpeechPhraseReplacement', 'DISPIDSPTSI_SelectionOffset',
    'SPSMF_SRGS_SAPIPROPERTIES', 'ISpRecoGrammar2', 'SPRECOSTATE',
    'eLEXTYPE_PRIVATE6', 'DISPID_SRCEPropertyStringChange',
    'eLEXTYPE_PRIVATE14', 'DISPID_SRCEventInterests',
    'SPINTERFERENCE_NONE', 'STCRemoteServer', 'SAFT44kHz16BitMono',
    'SpeechGrammarRuleStateTransitionType', 'SPLOADOPTIONS',
    'SPXRO_Alternates_SML', 'SGLexicalNoSpecialChars', 'SITooSlow',
    'UINT_PTR', 'ISpDataKey', 'SAFTNoAssignedFormat',
    'DISPID_SRRSpeakAudio', 'ISpXMLRecoResult', 'STCAll',
    'DISPID_SASetState', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPEI_RESERVED1', 'SPEVENTSOURCEINFO', 'SBOPause',
    'DISPID_SRCESoundStart', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SVP_16', 'SAFTExtendedAudioFormat', 'SAFTCCITT_ALaw_11kHzMono',
    'SREInterference', 'SVP_19', 'DISPID_SRGCmdSetRuleState',
    'ISpRecoGrammar', 'DISPID_SMSAMMHandle', 'SPEI_UNDEFINED',
    'ISpeechRecognizerStatus'
]

_check_version('1.2.0', 1684151953.675479)
